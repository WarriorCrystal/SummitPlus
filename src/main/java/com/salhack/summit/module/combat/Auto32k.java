...
import com.salhack.summit.util.entity.ItemUtil;
...
{
    public final Value<String> Mode = new Value<>("Mode", new String[] { "M" }, "Which mode to use", "Hopper");
            ...
            else
            {
                ...
                for (int l_I = 0; l_I < 9; ++l_I)
                {
                    ...
                    if (ItemUtil.Is32k(l_Stack))
                    {
                        ...
                        Aura l_KillAura = (Aura) ModuleManager.Get().GetMod(Aura.class);
    ...
    private boolean IsValidBlockPos(final BlockPos p_Pos)
    {
        ...
        {
            BlockInteractionHelper.ValidResult l_Result = BlockInteractionHelper.valid(p_Pos);
