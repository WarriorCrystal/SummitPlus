...
import com.salhack.summit.events.MinecraftEvent.Era;
...
public class SpeedModule extends Module
{
    ...
    private Listener<EventPlayerMove> OnPlayerMove = new Listener<>(p_Event ->
    {
        ...
        {
            if (mc.player.capabilities.isFlying || ModuleManager.Get().GetMod(Flight.class).isEnabled() || mc.player.isElytraFlying())
                return;
        }
